...
class PreAuthToken(Token):
    ...
    token_type = 'pre_auth'
    lifetime = api_settings.ACCESS_TOKEN_LIFETIME  # Inherit the default lifetime of AccessToken
...
class FullAuthToken(AccessToken):
    """Token used for full authentication, providing access to all resources."""
